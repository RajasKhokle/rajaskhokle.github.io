...
<ol>
  ...
  <li>Insulin Humulin  </li>
  <li>Insulin Lantus SoloStar</li>
  <li>Ins Humulin Cartridge</li>
</ol>
...
<h1> <strong>Data Modelling - Seasonality Decomposition </strong> </h1>
Any realistic timeseries has some trend, some seasonality and some random behaviour. This can be visualized and analyzed by performing the seasonal decomposition of the timeseries data. 
